...
(function(global) {
    ...
    function Dword() {
        var Ace,
            ...
            showMessageOnce = once(function(msg) {
                dword.showMessage(msg);
            }),
        ...
        dword.copyToClipboard = function() {
            var msg = 'Could not copy, use &ltCtrl&gt + &ltС&gt insted!';
            
            if (!clipboard('copy'))
                smalltalk.alert(TITLE, msg, {cancel: false});
        };
        
        dword.cutToClipboard = function() {
        ...
        dword.pasteFromClipboard = function() {
