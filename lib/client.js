            ...
            addExt(name, function(name) {
                ...
                dword.setMode(mode, function() {
                    var reg     = /^(css|json|yaml|javascript|coffeescript)$/,
                        ...
                        NUMBERS = 'CodeMirror-linenumbers',
                        
                        set     = function(option) {
                            var arr,
                                marker  = 'CodeMirror-lint-markers',
                                markers = [
                                    NUMBERS,
                                    marker
                                ],
                                
                                gutters = Ace.getOption('gutters'),
                                is      = ~gutters.indexOf(marker);
                            
                            dword.setOption('lint', option);
                            
                            if (!is) {
                                arr = markers.slice();
                                arr.push(marker);
                                dword.setOption('gutters', arr);
                            }
                        };
